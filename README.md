...
<div class="container">
			<div class="header_left">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i> +(91) 921 918 811</li>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="#">metalhelathcare@gmail.com</a></li>
				</ul>
			</div>
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a href="/doctor_reg/">Doctor Signup</a></li>
										<li class="divider"></li>
										<li><a href="/user_reg/">User SignUp</a></li>
										<li class="divider"></li>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>Mental Health Care Treatments</p>
							...
							<!-- <div class="carousel-inner"> -->
									...
									<blockquote>
										<div class="test_grid">
											<div class="col-sm-3 text-center test_img">
												<img src="/static/images/ts1.jpg" alt=" " class="img-responsive" />
								...
								<!-- <div class="item">
									<blockquote>
										<div class="test_grid">
											<div class="col-sm-3 text-center test_img">
												<img src="/static/images/ts2.jpg" alt=" " class="img-responsive" />
											</div>
											<div class="col-sm-9 test_img_info">
								...
								<!-- <div class="item">
									<blockquote>
										<div class="test_grid">
											<div class="col-sm-3 text-center test_img">
												<img src="/static/images/ts3.jpg" alt=" " class="img-responsive" />
											</div>
											<div class="col-sm-9 test_img_info">
												<p>Maecenas quis neque libero. Class aptent taciti.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
													auctor nec lacus ut tempor. Mauris.</p>
...
<!-- 	<div class="banner-bottom">
		<div class="container">
			...
			<div class="inner_sec_info_agileits_w3">
				<div class="col-md-4 grid_info">
					<div class="icon_info">
						<img src="/static/images/g4.jpg" alt=" " class="img-responsive">
				...
				<div class="col-md-4 grid_info">
					<div class="icon_info">
						<img src="/static/images/g6.jpg" alt=" " class="img-responsive">
	...
	<div class="footer_top_agile_w3ls">
		<div class="container">
			...
			<div class="col-md-3 footer_grid">
				<h3>Contact Info</h3>
				<ul class="address">
					<li><i class="fa fa-map-marker" aria-hidden="true"></i>Thrissur <span>Kerala, India.</span></li>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">mentalhealth@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+9187 8088 9436</li>
				</ul>
			</div>
			<!-- <div class="col-md-3 footer_grid ">
	...
	<div class="footer_wthree_agile">
		<p>© 2022 New Clinic. All rights reserved | Design by <a href="#">WebDesigner</a></p>
	</div>
	<!-- //footer -->
